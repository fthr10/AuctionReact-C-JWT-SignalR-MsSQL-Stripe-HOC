...
function CreateVehicle() {
    ...
    const handleCreateOrUpdateChange = (e:React.ChangeEvent<HTMLFormElement>) => {
        ...
        console.log(typeof(imageToBeStore));
        ...
        .then((response:any) => {
            if (response?.data?.isSucces) {
                ToastrNotify("Create process is success", "success");
    ...
    const handleFileChange = (e:React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (file) {
            ...
            reader.onload = (e) => {
                ...
                {imageToBeDisplay && (
    <img src={imageToBeDisplay} alt="Selected Vehicle" style={{ width: "100px", height: "100px" }} />
)}
